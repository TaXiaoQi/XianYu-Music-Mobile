...
class FilePickerWindows extends FilePicker {
  ...
  List<String>? _pickFilesImpl(_OpenSaveFileArgs args) {
  ...
  Future<String?> getDirectoryPathImpl({
    ...
    return compute(_getDirectoryPathImplIsolate, {
      'dialogTitle': dialogTitle,
      'initialDirectory': initialDirectory,
      'lockParentWindow': lockParentWindow,
    });
  ...
  String? _getDirectoryPathImplIsolate(Map<String, Object?> args) {
  ...
  static void _callPickFiles(_OpenSaveFileArgs args) {
    ...
    args.port.send(impl._pickFilesImpl(args));
  }
