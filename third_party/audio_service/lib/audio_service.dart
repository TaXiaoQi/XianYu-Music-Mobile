...
class AudioService {
  ...
  static Future<T> init<T extends AudioHandler>({
    ...
    _cacheManager = cacheManager ??= await _initCacheManager();
  ...
  static Future<BaseCacheManager> _initCacheManager() async {
    final existing = DefaultCacheManager.instance;
    if (existing != null) return existing;
    return DefaultCacheManager.init();
  }
