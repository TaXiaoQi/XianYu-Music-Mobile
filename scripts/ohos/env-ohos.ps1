...
# 424s on some package indexes (observed for `synchronized` on 2026-09-11) -
# pub.dev is reachable from this machine, so it is the ohos-session default.
# Override with PUB_HOSTED_URL_OVERRIDE to force the CN mirror.
